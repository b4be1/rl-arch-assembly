...
def load_config(project_root: Path) -> RunConfig:
    ...
    task_path = project_root / "data" / "tasks" / "box_triple_short"
    ...
    def env_factory(_robot_parameters_path=robot_parameters_path, _properties=properties,
        ...
        env_config.env_args["sensors"].append(FixedNumberPlacedPartsPoseSensor(max_nr_placed_parts=2))
        env_config.env_args["sensors"].append(FixedNumberPlacedPartsTargetPoseSensor(max_nr_placed_parts=2))
