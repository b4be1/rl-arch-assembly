# import cv2    # TODO: Cannot install cv2 at the moment due to some problems with Qt (probably caused by Coppelia)
import numpy as np
import torch
...
class GymEnv:
    def __init__(self, env: str, symbolic: bool, seed: int, max_episode_length: int, action_repeat: int,
                 bit_depth: int):
        import logging
        import gym
        assert action_repeat >= 1, "The number of action_repeats must be at least 1"
