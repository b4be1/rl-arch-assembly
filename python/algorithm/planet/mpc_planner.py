...
class MPCPlanner(jit.ScriptModule):
    ...
    def __init__(self, action_size: int, planning_horizon: int, optimization_iters: int, candidates: int,
                 top_candidates: int, transition_model: TransitionModel, reward_model: RewardModel,
                 min_action: float = -inf, max_action: float = inf):
        super().__init__()
        ...
        self.optimisation_iters = optimization_iters
