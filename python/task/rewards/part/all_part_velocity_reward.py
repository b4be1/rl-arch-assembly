...
class AllPartVelocityReward(PartVelocityReward):
    """
    ...
    def __init__(self, max_linear_velocity: float = 1.0,
        ...
        """
        super().__init__("all", max_linear_velocity, max_angular_velocity, intermediate_timestep_reward_scale,
                         final_timestep_reward_scale, abbreviated_name="part_vel")
