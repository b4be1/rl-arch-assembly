...
class PlacedPartMarkerReward(PartMarkerReward):
    """
    A concrete implementation of PartMarkerReward that takes all parts that are already placed into account.
    """
