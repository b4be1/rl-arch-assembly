...
class ArmJointTorqueReward(JointTorqueReward):
    """
    A reward that punishes high joint torques of the arm.
    """

    def __init__(self, robot_name: str = "ur10", max_torque: float = 200.0,
        ...
        :param exponent:                            the exponent to use in the calculation of the cost (e.g. 2 for a
                                                    squared cost)
        """
        super().__init__("arm_", max_torque, intermediate_timestep_reward_scale, final_timestep_reward_scale, exponent)
